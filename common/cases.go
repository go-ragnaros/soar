...
func init() {
	...
	TestSQLs = []string{
		...
		// https://github.com/go-ragnaros/soar/issues/47
		...
		// https://github.com/go-ragnaros/soar/issues/17
		"create table hello.t (id int unsigned);",

		// https://github.com/go-ragnaros/soar/issues/146
		"select * from tb where data >= '';",

		// https://github.com/go-ragnaros/soar/issues/163
