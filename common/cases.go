...
func init() {
	...
	TestSQLs = []string{
		...
		// https://github.com/zeusYi/soar/issues/47
		...
		// https://github.com/zeusYi/soar/issues/17
		"create table hello.t (id int unsigned);",

		// https://github.com/zeusYi/soar/issues/146
		"select * from tb where data >= '';",

		// https://github.com/zeusYi/soar/issues/163
